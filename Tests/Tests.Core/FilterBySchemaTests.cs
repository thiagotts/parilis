...
namespace Tests.Core {
    ...
    public class FilterBySchemaTests : MockTest {
        ...
        [Test]
        public void WhenCallIsMadeWithNoArguments_MustReturnTheOwnDatabaseDescription() {
        ...
        [Test]
        public void WhenCallIsMadeWithInexistentSchema_MustReturnAnEmptyDatabaseDescription() {
        ...
        [Test]
        public void MustReturnTheConnectionInfoAfterFiltering() {
            var filteredDatabaseDescription = actualDatabase.FilterBySchema("dbo");

            Assert.That(filteredDatabaseDescription.ConnectionInfo, Is.Not.Null);
        }

        [TestCase(null)]
        [TestCase("")]
        public void WhenCallIsMadeWithNullOrEmptySchema_MustReturnADatabaseWithEmptyDescription(string nullOrEmptySchema) {
        ...
        [Test]
        public void WhenCallIsMadeWithExistentSchema_MustReturnOnlyElementsThatBelongToTheSchema() {
            var dboSchema = "dbo";
            var otherSchema = "other";
        ...
        [Test]
        public void WhenCallIsMadeWithManyExistentSchemas_MustReturnOnlyElementsThatBelongToOneOfTheSchemas() {
            var dboSchema = "dbo";
            var otherSchema = "other";
            var otherSchema1 = "other1";
